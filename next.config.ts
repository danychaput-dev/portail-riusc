...
const securityHeaders = [
  ...
  // Content Security Policy
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://api.mapbox.com https://cdn.jsdelivr.net https://embed.tawk.to https://*.tawk.to",
      "style-src 'self' 'unsafe-inline' https://api.mapbox.com https://fonts.googleapis.com https://*.tawk.to",
      "img-src 'self' data: blob: https://*.supabase.co https://api.mapbox.com https://*.mapbox.com https://*.tawk.to",
      "font-src 'self' https://fonts.gstatic.com https://*.tawk.to",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.mapbox.com https://*.mapbox.com https://n8n.aqbrs.ca https://events.mapbox.com https://*.tawk.to wss://*.tawk.to",
