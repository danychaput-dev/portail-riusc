...
export const DEMO_MESSAGES = [
  ...
  // ── Canal : questions ──
  {
    ...
    auteur_nom: 'Isabelle Roy',
    auteur_photo: null,
    contenu: 'Est-ce qu\'on peut apporter notre propre sac de couchage au camp de qualification ou c\'est fourni ?',
    canal: 'questions',
  ...
  },
  {
    ...
    auteur_nom: 'Sophie Bergeron',
    auteur_photo: null,
    contenu: 'C\'est fourni sur place (lits de camp + couvertures), mais tu peux apporter un sac de couchage si tu préfères. Je recommande !',
    canal: 'questions',
  ...
  // ── Canal : entraide ──
  {
    ...
    auteur_nom: 'Martin Gagnon',
    auteur_photo: null,
    contenu: 'Petit conseil pour ceux qui se préparent au camp : amenez des vêtements en couches. Le matin c\'était froid mais l\'après-midi en plein soleil avec les exercices, on avait chaud ! 🥵',
    canal: 'entraide',
  ...
  },
  {
    ...
    auteur_nom: 'Isabelle Roy',
    auteur_photo: null,
    contenu: 'Bon tip ! J\'ajouterais : des bonnes bottes de travail bien rodées. C\'est pas le moment de les essayer pour la première fois 😅',
    canal: 'entraide',
  ...
  },
  {
    ...
    auteur_nom: 'Alexandre Côté',
    auteur_photo: null,
    contenu: 'Pour ceux de la région de Québec qui veulent covoiturer vers Nicolet pour le prochain camp, je pars de Lévis et j\'ai 3 places. Écrivez-moi !',
    canal: 'entraide',
