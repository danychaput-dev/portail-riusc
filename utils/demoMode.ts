...
export const DEMO_MESSAGES = [
  ...
  },
  {
    ...
    auteur_nom: 'Martin Gagnon',
    auteur_photo: null,
    contenu: 'Ça varie selon le sinistre. Pour les inondations, on a eu environ 48-72h de préavis. Pour un feu de forêt, ça peut être plus rapide. L\'important c\'est de garder tes dispos à jour.',
    canal: 'questions',
  ...
  },
  {
    ...
    auteur_nom: 'Isabelle Roy',
    auteur_photo: null,
    contenu: 'Bon tip ! J\'ajouterais : des bonnes bottes de travail bien rodées. C\'est pas le moment de les essayer pour la première fois en déploiement 😅',
    canal: 'entraide',
