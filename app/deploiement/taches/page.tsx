...
const TACHES: TacheData[] = [
  {
    ...
    epiRequis: ['ÉPI de base : Bottes de travail conformes, lunettes de protection, gants de travail, dossard haute visibilité', 'Selon contexte / briefing : casque'],
  ...
  },
  {
    ...
    messagePortail: 'Seul un très petit nombre de réservistes manipulent les scies à chaîne (munis d\u2019ÉPI spécialisés). MAIS la sécurité est l\u2019affaire de TOUS, pas seulement des opérateurs. Soyez constamment vigilants : respectez les périmètres de sécurité, ne vous approchez JAMAIS d\u2019un opérateur en action (il peut ne pas vous entendre), et signalez immédiatement tout danger. Votre vigilance protège tout le monde.',
    aSavoir: ['AU SOL uniquement : aucun abattage d\u2019arbre debout.', 'Deux pieds au sol : aucun travail en hauteur (pas d\u2019échelle, pas d\u2019escalade).', 'VIGILANCE COLLECTIVE : même si tu ne manipules pas l\u2019outil, tu respectes absolument le périmètre de sécurité et tu restes à l\u2019écoute.', 'Les opérateurs de scie peuvent ne pas t\u2019entendre : ne t\u2019approche JAMAIS d\u2019un opérateur en action sans contact visuel confirmé.', 'Si une situation est instable (bois sous tension complexe), tu t\u2019arrêtes et tu réfères immédiatement.'],
    limites: ['AU SOL uniquement - aucun abattage.', 'Aucun travail en hauteur.', 'Activité avec outil motorisé réservée aux personnes habilitées avec ÉPI complet.', 'TOUS les réservistes doivent respecter les zones de sécurité et les consignes, qu\u2019ils manipulent ou non l\u2019équipement.'],
    epiRequis: ['ÉPI de base (TOUS) : Bottes de travail conformes, lunettes de protection, gants de travail, dossard haute visibilité', 'ÉPI spécialisé (opérateurs scie uniquement) : Casque avec visière grillagée, protecteurs auditifs, pantalon anti-coupure, bottes avec embout d\u2019acier', 'Selon contexte / briefing : casque pour assistance'],
    formations: ['Camp de qualification RIUSC', 'Habilitation outil avec ÉPI spécialisé (opérateurs scie uniquement)', 'Briefing sécurité périmètre (TOUS avant intervention)'],
  },
  {
    id: 3,
    ...
    messagePortail: 'Cette activité implique souvent la coactivité avec des équipements lourds (chargeurs, camions) et manuels (brouettes, outils). La sécurité dépend de TOUS : que tu manipules des débris ou non, tu dois TOUJOURS connaître la position des équipements autour de toi. Les opérateurs ont des angles morts - ne te fie JAMAIS au fait qu\u2019ils t\u2019ont vu. Établis un contact visuel avant d\u2019entrer dans une zone de manœuvre. Les objets peuvent être lourds, tranchants ou contaminés. Ta vigilance constante protège toute l\u2019équipe.',
    aSavoir: ['COACTIVITÉ : des équipements lourds et manuels opèrent simultanément. Garde TOUJOURS une conscience spatiale de ce qui bouge autour de toi.', 'Les opérateurs ont des angles morts : ne JAMAIS présumer qu\u2019ils t\u2019ont vu. Établis un contact visuel AVANT d\u2019entrer dans leur zone de travail.', 'Respecte absolument les zones balisées et les consignes de circulation. Ne traverse JAMAIS une zone active sans autorisation.', 'Avant de manipuler un objet, identifie les dangers : verre, clous, métal tranchant, produits contaminants, instabilité.', 'Si un objet semble dangereux (bonbonne, batterie, produit chimique, débris sous tension), tu isoles et tu signales immédiatement.', 'Travail physique exigeant : respecte les rotations prévues, hydrate-toi régulièrement et signale la fatigue tôt.'],
    limites: ['Dégagement d\u2019accès uniquement (pas de rétablissement complet).', 'Opération d\u2019équipement lourd réservée aux opérateurs qualifiés.', 'TOUS les réservistes doivent respecter les zones de manœuvre, les consignes de circulation et communiquer leur position.', 'Isoler et signaler immédiatement les objets potentiellement dangereux.'],
    epiRequis: ['ÉPI de base (TOUS) : Bottes de travail conformes avec embout d\u2019acier, lunettes de protection, gants de travail résistants, dossard haute visibilité', 'Selon contexte / briefing : casque (obligatoire si machinerie), protection respiratoire (poussière/contamination)'],
    formations: ['Camp de qualification RIUSC', 'Sensibilisation coactivité et dangers (TOUS)', 'Briefing circulation/zones (TOUS avant intervention)', 'Manutention sécuritaire (selon rôle)'],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    epiRequis: ['ÉPI de base : Chaussures fermées appropriées,  dossard haute visibilité', 'Selon contexte / briefing : masque, gants'],
  ...
  },
  {
    ...
    epiRequis: ['ÉPI de base : Chaussures fermées appropriées, dossard haute visibilité', 'Selon contexte / briefing : gants'],
