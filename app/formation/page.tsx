...
function FormationContent() {
  ...
  const handleFormationCertUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      // 1. Upload direct vers Supabase Storage (évite la limite 4.5MB de Vercel sur les API routes)
          ...
          <div style={{ backgroundColor: 'white', borderRadius: '12px', padding: '32px', maxWidth: '550px', width: '100%', maxHeight: '90vh', overflowY: 'auto', boxShadow: '0 20px 60px rgba(0,0,0,0.3)' }}>
            {inscriptionSuccess ? (
              ...
              <>
                ...
                <p style={{ color: '#6b7280', margin: '0 0 16px 0', fontSize: '14px' }}>{campStatus?.has_inscription ? 'Sélectionnez un autre camp si vous souhaitez modifier votre inscription.' : 'Sélectionnez le camp auquel vous souhaitez participer.'}</p>
