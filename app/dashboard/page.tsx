        ...
        {stats && (
          <>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? 'repeat(2, 1fr)' : 'repeat(4, 1fr)', gap: 16, marginBottom: 24 }}>
              <StatCard value={stats.totalInscrits}    label="Réservistes inscrits" onClick={drill({ groupes: 'Approuvé,Intérêt,Partenaires,Formation incomplète,Responsable', label: 'Tous les réservistes inscrits' })} />
              ...
              <Card title="Nouvelles inscriptions">
                <div style={{ display: 'flex', gap: 40, borderBottom: `1px solid ${BORDER}`, paddingBottom: 16, marginBottom: 16, flexWrap: 'wrap' }}>
                  {[
                    ...
                    <div key={i} onClick={drill({ inscrit_depuis: String(s.jours), groupes: 'Approuvé,Intérêt,Partenaires,Formation incomplète,Responsable', label: `Nouvelles inscriptions — ${s.label.toLowerCase()}` })}
